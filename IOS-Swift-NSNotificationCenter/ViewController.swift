...
let orangNotificationKey = "co.app.pooya.orange"
...
class ViewController: UIViewController {
    ...
    let orange = Notification.Name(rawValue: orangNotificationKey)
    ...
    @objc func updateViewImage(notification: Notification)  {
        let isAplle = notification.name == apple
        let image = isAplle ? UIImage(named: "apple")! : UIImage(named: "orange")!
